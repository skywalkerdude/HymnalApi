...
def get_latest_android_version_number():
    return json.dumps({LATEST_CLIENT_VERSION : 14}, sort_keys=False)

@latest_client_version.route('/latestVersionAndroid')
def get_hymn():
    return redirect("https://drive.google.com/file/d/0B3XbhMal4IMvNlFqTU1pN0NoSmc/view?usp=sharing", code=302)
