...
def get_latest_android_version_number():
    return json.dumps({LATEST_CLIENT_VERSION : 6}, sort_keys=False)

@latest_client_version.route('/latestVersionAndroid')
def get_hymn():
    return redirect("https://drive.google.com/file/d/0B3XbhMal4IMvV0JtX0tpa1dyQ0E/view?usp=sharing", code=302)
