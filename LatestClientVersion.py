...
def get_latest_android_version_number():
    return json.dumps({LATEST_CLIENT_VERSION : 24}, sort_keys=False)

@latest_client_version.route('/latestVersionAndroid')
def get_hymn():
    return redirect("https://drive.google.com/file/d/1Gyh4ASiJQ_pzyc3auAYa1CkMb5WstdSX/view?usp=sharing", code=302)
